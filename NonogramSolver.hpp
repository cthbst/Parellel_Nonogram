...
// NonogramSolver<int,int>::Range::Range()
// {
// 	Range::cntBlack = 0;
// }

// NonogramSolver::Record_type::Record_type()
// {
// 	NonogramSolver::Record_type::LinePutToLimit = 0;
// 	NonogramSolver::Record_type::AllPutToLimit = 0;
// }

// NonogramSolver::Line::Line()
// {
// 	memset(line,0,sizeof(line)) ;
// }

// State& NonogramSolver::Line::operator[] (const int id)
// {
// 	return line[id];
// }

// void NonogramSolver::Line::init()
// {
...
// void NonogramSolver::Line::intersection()
// {
...
// void NonogramSolver::Line::getCntBlack(Range &rang){
// 	rang.cntBlack=0 ;
...
// 	}
// }
// bool NonogramSolver::Line::rangeOK(Range rang){
// 	getCntBlack(rang) ;
...
// 	return 1 ;
// }
// void NonogramSolver::Line::putToLimit(){
...
// bool NonogramSolver::Line::LineOK(){
...
void NonogramSolver::putToLimit(){
...
void NonogramSolver::LogicSolve(){
	do {
		putToLimit() ;
	}while( intersection()==1 ) ;
}

bool NonogramSolver::Union(){
	bool updated=0 ;
	for (int i=1 ;i<=cntRow ;i++ ){
...
bool NonogramSolver::intersection(){
	for (int i=1 ;i<=cntCol ;i++ )
		Col[i].intersection() ;
	for (int i=1 ;i<=cntRow ;i++ )
		Row[i].intersection() ;
...
template<int ll>void NonogramSolver::inputRanges(ifstream &fin ,Line<ll> line[] ,int cntLine )
{
...
void NonogramSolver::input(string filename){
	ifstream fin(filename.c_str()) ;
	input(fin) ;
}

void NonogramSolver::input(ifstream &fin ){
	inputRanges(fin,Col,cntCol) ;
	inputRanges(fin,Row,cntRow) ;
	init() ;
}

void NonogramSolver::output(ostream &fout = cout)
{
